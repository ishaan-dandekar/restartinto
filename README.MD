...
A simple GNOME Shell extension that adds a "Restart to" button to the restart dialog, making dual-boot switching effortless.
...
3. **Follow the prompts**:
   ...
   - Scan for preferred OS boot entries
